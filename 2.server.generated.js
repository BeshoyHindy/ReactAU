...
var _ProductsTblPage = __webpack_require__(452);
...
var AdminListProductPage = function (_React$Component) {
	_inherits(AdminListProductPage, _React$Component);

	function AdminListProductPage(props) {
		_classCallCheck(this, AdminListProductPage);
	...
	AdminListProductPage.prototype.componentDidMount = function componentDidMount() {};

	AdminListProductPage.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {};

	AdminListProductPage.prototype.setCategory = function setCategory(e) {
	...
	AdminListProductPage.prototype.render = function render() {
		var _this2 = this;
...
var AdminListProductPageWrap = (0, _reactRedux.connect)(mapStateToProps)((0, _connectDataFetchers2.default)(AdminListProductPage, [_productsActions.loadProductList]));
